...
const SongDetails = () => {
  ...
  if (isFetchingSongDetails && isFetchinRelatedSongs) {
    return <Loader title="Идёт загрузка детали песни" />;
  }
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mb-10">
        <h2 className="text-white text-3xl font-bold">Tехт песни</h2>
        ...
        <div className="mt-5">
          {songData?.sections[1].type === 'LYRICS' ? (
            ...
            <p className="text-gray-400 text-base my-1">Извините не нашли текст песни</p>
          )}
        </div>
      </div>
